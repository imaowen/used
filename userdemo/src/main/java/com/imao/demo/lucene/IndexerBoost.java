 ...
 *
 */
public class IndexerBoost {

	private String ids[]={"1","2","3","4"};
	private String authors[]={"Jack","Marry","John","Json"};
	private String positions[]={"accounting","technician","salesperson","boss"};
	private String titles[]={"Java is a good Java language.","Java is a cross platform language","Java powerful","You should learn java"};
...
//			}
		...
		System.out.println("索引："+writer.numDocs()+" 个文件");
		writer.close();
	}
	/**
	 * 查询
	...
	public void search()throws Exception{
		...
		for(ScoreDoc scoreDoc:hits.scoreDocs){
			...
			System.out.println(doc.get("author")+"\t"+doc.get("position")+"\t"+doc.get("title"));
		}
		reader.close();
	}
}
